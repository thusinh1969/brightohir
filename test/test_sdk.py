...
class TestFullIntegration:
    ...
    def test_converter_count(self):
        """Verify we have 19 V2→R5 and 15 R5→V2 converters."""
        from brightohir.convert_v2 import _SEGMENT_CONVERTERS, _R5_TO_V2_CONVERTERS
        assert len(_SEGMENT_CONVERTERS) == 19, f"Expected 19 V2→R5, got {len(_SEGMENT_CONVERTERS)}"
        assert len(_R5_TO_V2_CONVERTERS) == 15, f"Expected 15 R5→V2, got {len(_R5_TO_V2_CONVERTERS)}"
